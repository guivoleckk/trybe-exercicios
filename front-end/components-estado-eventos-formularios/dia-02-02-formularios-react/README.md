...
- Use o comando: `git clone git@github.com:tryber/sd-029-b-exercise-react-form`
- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-029-b-exercise-react-form`
...
- Agora crie uma branch à qual você vai submeter os `commits` do seu exercício
  ...
  - Exemplo: `git checkout -b fernando-soares-sd-029-b-exercise-react-form`
...
- Usando o exemplo anterior: `git push -u origin joaozinho-sd-029-b-exercise-react-form`

6. Crie um novo `Pull Request` _(PR)_

- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-029-b-exercise-react-form/pulls)
...
- Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-029-b-exercise-react-form/pulls) e confira que o seu _Pull Request_ está criado
