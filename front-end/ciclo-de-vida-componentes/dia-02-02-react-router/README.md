...
- Use o comando: `git clone git@github.com:tryber/sd-029-b-exercise-pokedex-router`.
- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-029-b-exercise-pokedex-router`
...
- Agora crie uma branch à qual você vai submeter os `commits` do seu exercício
  ...
  - Exemplo: `git checkout -b joaozinho-sd-029-b-exercise-pokedex-router`
...
- Usando o exemplo anterior: `git push -u origin joaozinho-sd-029-b-exercise-pokedex-router`

6. Crie um novo `Pull Request` _(PR)_

- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-029-b-exercise-pokedex-router/pulls)
...
- Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-029-b-exercise-pokedex-router/pulls) e confira que o seu _Pull Request_ está criado
...
<details>
  ...
  [FORMULÁRIO DE AVALIAÇÃO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH29-B&template=betrybe/sd-0x-exercise-pokedex-router)
